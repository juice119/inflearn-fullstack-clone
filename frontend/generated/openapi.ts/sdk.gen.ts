...
export const mediaControllerUpload = <ThrowOnError extends boolean = false>(options: Options<MediaControllerUploadData, ThrowOnError>): RequestResult<MediaControllerUploadResponses, unknown, ThrowOnError> => (options.client ?? client).post<MediaControllerUploadResponses, unknown, ThrowOnError>({
